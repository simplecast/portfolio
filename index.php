    ...
    <div id="page-content-wrapper">
      <div class="container-fluid">
        <div class="banner jumbotron ">
            ...
            <div class="page-header modal-header header">
                <h1 class="col-md-12" id="headertext">Salutations my name is Kishon Diaz </h1>   
            </div>
            <div class="context">
                <div class="span mx-auto">I am passionate about programming and expanding my knowledge in the field of technology. I have strong work ethics, dependable and professional. Once I am given the opportunity to be a programmer for your company it will open the door to develop new technologies and innovative ideas.<br>
                </div>
            <div class="projections">
              <div class="row">
               ...
               <div class="mx-auto">     
                ...
                <div class="carousel-inner col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-2" role="listbox">
